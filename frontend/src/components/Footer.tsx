...
const SOCIAL = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/CodersSpot',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/codersspot_',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@codersspotofficial',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/coders-spot',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
