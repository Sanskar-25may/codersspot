      ...
      <div className="max-w-7xl mx-auto px-6 py-20 w-full z-10">
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
          ...
          <h1 className="heading-font text-5xl md:text-6xl font-bold">
            Alumni <span className="shimmer-text">Projects</span>
          </h1>
          <p className="text-base md:text-lg font-medium" style={{ color: 'var(--text-secondary)' }}>
            Explore production-grade applications built by our students. This is the portfolio you will graduate with.
          </p>
        </div>
          ...
          {projects.map((project: any, index: number) => (
            ...
            >
              ...
              <div className={`w-full lg:w-1/2 ${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                <div
                  className="rounded-[32px] overflow-hidden border shadow-2xl relative aspect-video"
              ...
              <div className="w-full lg:w-1/2 space-y-6">
                ...
                <h2 className="heading-font text-3xl font-bold">{project.title}</h2>
                ...
                <div className="flex gap-4">
                  {project.githubLink && (
                    <a
                      ...
                      className="px-5 py-2.5 rounded-xl text-xs font-bold border hover:opacity-80 transition-all duration-200 flex items-center gap-2"
