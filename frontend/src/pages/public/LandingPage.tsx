    ...
    >
      ...
      <section className="relative py-24 px-6 overflow-hidden flex flex-col items-center justify-center text-center max-w-5xl mx-auto space-y-8 w-full">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <Link
            to="/projects"
            className="px-7 py-3.5 rounded-xl text-sm font-bold border hover:opacity-80 transition-all duration-200 flex items-center gap-2"
            style={{ borderColor: 'var(--border-med)', background: 'var(--bg-card)' }}
          >
            <span className="mono-font text-xs opacity-75">&lt;/&gt;</span> View Alumni Projects
          </Link>
          <a
            href="https://wa.me/917355259488?text=Hi%2C%20I%27d%20like%20to%20enquire%20about%20your%20courses%20at%20CodersSpot."
            target="_blank"
            rel="noopener noreferrer"
            className="px-7 py-3.5 rounded-xl text-sm font-bold flex items-center gap-2 hover:scale-[1.03] transition-all duration-200 border"
            style={{
